...
async def startHandler(bot:Update, msg:Message):
    ...
    await msg.reply_text(
        "<b>Hi, I am request bot.\nHow to Request in Our Chanel??</b><p>\n\t1. Join Movieshub Comments\n\t2. Type #request  (Your Query)\n\t3. Wait until admins look at your post and accept it, After accepting your request we will uploaded as soon as possible.\n\t4.</b>",
        parse_mode = "html",
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "•> Movieshub	Comments<•",
                        url = f"https://t.me/+FhqAz1CfxcFjYmI1"
                    )
                ]
            ]
        )
                ...
                if document[key][0] != channelID:
                    ...
                    if user.status not in ("administrator", "creator"): # If accepting, rejecting request tried to be done by neither admin nor owner
                        ...
                        if data == "reject":
                            ...
                            result = "COMPLETED"
                            groupResult = "has been uploaded. Checkout out the app/website."
